...
export function bindDynamicKeys (baseObj: Object, values: Array<any>): Object {
    for (let i = 0; i < values.length; i += 2) {
        ...
        if (typeof key === 'string' && key) {
            ...
            // null is a speical value for explicitly removeing a binding
            warn(
...
// helper to dynamically append midifier runtime markers to event names.
